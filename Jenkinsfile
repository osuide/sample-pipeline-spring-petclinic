       ...
       stage('Sonar') {
           agent  {
            ...
            steps {
                   ...
                   sh '/opt/sonar-scanner/bin/sonar-scanner -X -Dsonar.projectKey=petclinic -Dsonar.login=1a68b418420076d4f5e99d0debb3491c226acd45 -Dsonar.host.url=http://host.docker.internal:19000 -Dsonar.java.binaries=/bin'
                 }
               }
