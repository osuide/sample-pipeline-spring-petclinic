       ...
       stage('Sonar') {
           agent  {
            ...
            steps {
                   ...
                   sh '/opt/sonar-scanner/bin/sonar-scanner -X -Dsonar.projectKey=petclinic -Dsonar.login=044225c47830605915751165315438f79fae5509 -Dsonar.host.url=http://host.docker.internal:19000 -Dsonar.java.binaries=/bin'
                 }
               }
