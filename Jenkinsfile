       ...
       stage('Sonar') {
           agent  {
            ...
            steps {
                   ...
                   sh '/opt/sonar-scanner/bin/sonar-scanner -X -Dsonar.projectKey=petclinic -Dsonar.login=2a24dc9e359cfe84b951973e46054361f98b12a7 -Dsonar.host.url=http://host.docker.internal:19000 -Dsonar.java.binaries=/bin'
                 }
               }
