       ...
       stage('Sonar') {
           agent  {
            ...
            steps {
                   ...
                   sh '/opt/sonar-scanner/bin/sonar-scanner -X -Dsonar.projectKey=petclinic -Dsonar.login=dde935ac21d85c1452c49c1e50eb2e12d7fb8f12 -Dsonar.host.url=http://host.docker.internal:19000 '
                 }
               }
